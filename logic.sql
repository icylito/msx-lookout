-- MSX Stock Lookout core logic (Phase 4)
-- exposed automatically as RPC: POST /rest/v1/rpc/<function>
...
-- automatically by CI (supabase db push) on every push to main. Make logic
